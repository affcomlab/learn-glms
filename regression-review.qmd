...
:::{.callout-note}
When we use fucntions, like `factor()`, we have explicitly written out the input arguments, such as <i>levels</i>, in order to show exactly what information the function is processing. 
:::
...
By default, this prints in code format as above. However, for the rest of the book, we will be using a prettier format called <i>markdown</i> format, as such.
