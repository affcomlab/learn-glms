...
Due to the nature of the dummy coded categorical variable `class`, we will assess the parameters from each level of that variable first. 
...
-   Notice how these comparisons are all in reference to the first class. Again, this is due to the nature of the dummy coded categorical variable. 
...
-   We now turn our attention to the continuous variable `age`. If log-odds of `age` is $ = -0.04$, then it is the case that we can say it is less likely for someone to survive the Titanic with an increase in age. 

-   This effect (age) is also statistically significant from 0 ($p<0.001$). 
...
> The members of the "2nd Class" have a 0.65, or 65% decrease, in the odds of suriving relative to the "1st Class" while accounting for the effect of `age` (i.e., they have a worse chance of surviving). It is a decrease because we are talking in odds and the value is less than 1. And we interpret that value as 0.65 because 1 - 0.35 = 0.65.

> The members of the "3rd Class" have 0.90 decrease, or 90% decrease, in the odds of suriving relative to the "1st Class" while accounting for the effect of `age`. (i.e., they have a worse chance of surviving).  It is a decrease because we are talking in odds and the value is less than 1. And we interpret that value as 0.90 because 1 - 0.10 = 0.90.
...
> Lastly, while accounting for the effect of `class`, a one unit increase in age was significantly related to a 0.04 decrease, or 4% decrease, in the odds of survival.  It is a decrease because we are talking in odds and the value is less than 1. And we interpret that value as 0.04 because 1 - 0.96 = 0.04. 
