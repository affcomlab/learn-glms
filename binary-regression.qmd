...
> The intercept is the average odds of surviving for the "1st Class" category while accounting for the effect of `age`. In this case, members of the "1st Class" have a average log odds of 2.10 indiciating that passengers in the 1st Class are more likely to survive.
...
> Lastly, while accounting for the effect of `class`, a one unit increase in age was significantly related to a 0.04 decrease in the log-odds of survival. 
